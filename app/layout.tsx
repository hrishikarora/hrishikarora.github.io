...
const TITLE = 'Hrishik Arora, Unity gameplay programmer'
const DESCRIPTION =
  'Unity gameplay programmer. Three commercial mobile titles shipped with VOODOO and Hungama Game Studio, including eight or more post-launch update cycles on a title past 100,000 downloads.'
